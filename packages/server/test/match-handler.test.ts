...
/*
 * The first command the protocol carries, so these are as much about the *shape* of a command
 * as about active sonar: nothing is sent back, a boat you do not command is not yours to
 * switch, and a malformed field is dropped rather than trusted. Whatever the second command
 * turns out to be, it has to pass this same set.
 */
